...
The queue system has been fully removed. All data is now saved immediately during collection and update workflows. Any references to queue management, queue status, or queue UI are deprecated.
