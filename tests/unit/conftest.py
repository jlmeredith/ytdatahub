"""
Pytest fixtures for unit tests in the YouTube Data Hub application.
"""
import sys
import os
import pytest
...
# Import with error handling for test discovery
try:
...
def sample_collection_options():
    """Return sample collection options for testing."""
    return {
